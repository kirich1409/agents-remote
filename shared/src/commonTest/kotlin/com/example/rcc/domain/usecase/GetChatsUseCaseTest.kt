...
class GetChatsUseCaseTest {
    @Test
    fun testGetChatsUseCaseReturnsChats() =
        runTest {
    ...
    @Test
    fun testGetChatsUseCaseReturnsFailureOnError() =
        runTest {
            val mockRepository =
                object : ChatRepository {
...
class CreateChatUseCaseTest {
    @Test
    fun testCreateChatUseCaseCreatesChat() =
        runTest {
    ...
    @Test
    fun testCreateChatUseCaseFailsOnBlankSessionId() =
        runTest {
            val mockRepository =
                object : ChatRepository {
                    override suspend fun getChats() = Result.failure<List<Chat>>(NotImplementedError())
...
class SendMessageUseCaseTest {
    @Test
    fun testSendMessageUseCaseFailsOnBlankChatId() =
        runTest {
            val mockRepository =
                object : ChatRepository {
                    override suspend fun getChats() = Result.failure<List<Chat>>(NotImplementedError())
    ...
    @Test
    fun testSendMessageUseCaseFailsOnBlankContent() =
        runTest {
            val mockRepository =
                object : ChatRepository {
                    override suspend fun getChats() = Result.failure<List<Chat>>(NotImplementedError())
    ...
    @Test
    fun testSendMessageUseCaseSendsMessage() =
        runTest {
            val expectedMessage =
                Message(
                    chatId = "chat-123",
            ...
            val mockRepository =
                object : ChatRepository {
                    ...
                    override suspend fun sendMessage(
                        chatId: String,
                        content: String,
                    ) = Result.success(expectedMessage)
                }
